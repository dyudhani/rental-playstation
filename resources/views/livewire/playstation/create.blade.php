<!-- Modal -->
<div wire:ignore.self class="modal fade" id="addPlaystationModal" tabindex="-1" aria-labelledby="addPositionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="addPositionModal">Tambah Playstation</h5>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" wire:click.prevent="store()">Add Playstation</button>
        </div>
        </div>
    </div>
</div>