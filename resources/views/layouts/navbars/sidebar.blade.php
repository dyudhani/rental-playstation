            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('employee') }}">
                        <i class="ni ni-single-02 text-primary"></i> {{ __('Employee') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('playstation') }}">
                        <i class="ni ni-laptop text-primary"></i> {{ __('Playstation') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('home') }}">
                        <i class="ni ni-folder-17 text-primary"></i> {{ __('Rental') }}
                    </a>
                </li>
                <li class="nav-item">
